/* ============================================================
   25VotePromo.js  —  Combined votes + promos, sorted by date
   ============================================================ */

(function () {
  const VOTES_URL      = "https://firestore.googleapis.com/v1/projects/madfut-25/databases/(default)/documents/votes/";
  const PROMOS_URL     = "https://firestore.googleapis.com/v1/projects/madfut-25/databases/(default)/documents/promotions/";
  const LOCAL_JSON_URL = "25assets/Txt/promo.json";

  const EXCLUDED_VOTE_IDS  = new Set(["VIcqh3JokCBpRKDQNue8"]);
  const EXCLUDED_PROMO_IDS = new Set(["BvMQXdwIM2Pqn0msoi85"]);
