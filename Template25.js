    ...
    <div class="search-box">
      ...
      <div class="search-year-filter" id="searchYearFilter">
        <button class="search-year-filter-btn" id="searchYearFilterBtn" aria-haspopup="listbox" aria-expanded="false" title="Filter by year">
          <img class="syf-img" id="syfImg" src="https://mf-data.b-cdn.net/web/Icons/madfut_25.png" alt="Year filter" onerror="this.style.display='none';this.nextElementSibling.style.display='block';">
          <span class="syf-img-fallback" id="syfFallback">25</span>
        </button>
        <div class="search-year-filter-drop" id="syfDrop" role="listbox">
          ...
          <button class="syf-drop-item active" data-year="25" role="option" aria-selected="true">
...
<div class="nav-drawer" id="navDrawer" aria-hidden="true">
  <div class="nav-drawer-inner">
    ...
    <div class="gen-row" role="group" aria-label="Select generation">
      ...
      <a href="#" class="gen-btn selected" data-year="25" aria-label="Madfut 25" aria-pressed="true">
  ...
  if (scroll) {
    ...
    bcWrap.innerHTML = `<div class="bc-year-wrap" id="bcYearWrap">
      <button class="bc-year-btn" id="bcYearBtn" aria-haspopup="listbox" aria-expanded="false">
        <span id="bcYearLabel">MADFUT 25</span>
...
const { PAGE_YEAR, PAGE_SLUG } = (function() {
  ...
  return m ? { PAGE_YEAR: m[1], PAGE_SLUG: m[2] } : { PAGE_YEAR: "25", PAGE_SLUG: file };
})();
